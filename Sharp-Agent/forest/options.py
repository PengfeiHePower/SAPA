...
def options():
    ...
    parser.add_argument('--dataset', default='CIFAR10', type=str, choices=['CIFAR10', 'CIFAR100', 'ImageNet', 'ImageNet1k', 'MNIST', 'TinyImageNet', 'SVHN'])
    ...
    # shapness
    parser.add_argument('--savename', default=None, type=str, help='poison data saving name')
    parser.add_argument('--sharpsigma', default=0.05, type = float, help='variance for sharpness')
